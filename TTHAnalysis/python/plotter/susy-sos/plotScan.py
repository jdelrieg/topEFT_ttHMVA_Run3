...
xsec = TChiWZ_xsec if args.signalModel=="TChiWZ" else HiggsPMSSM_xsec if args.signalModel=="HiggsPMSSM" else T2XX_xsec # else Higgsino_xsec if args.signalModel=="Higgsino" 
