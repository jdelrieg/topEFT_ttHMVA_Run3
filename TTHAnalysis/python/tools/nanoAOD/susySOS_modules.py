...
eventBTagWeight_16Fast = lambda : BTagEventWeightFriendFast(csvfile=os.environ["CMSSW_BASE"]+"/src/CMGTools/TTHAnalysis/data/btag/DeepCSV_2016LegacySF_V1.csv", csvfastsim=os.environ["CMSSW_BASE"]+"/src/CMGTools/TTHAnalysis/data/btag/deepcsv_13TEV_16SL_18_3_2019.csv", eff_rootfile=os.environ['CMSSW_BASE']+"/src/CMGTools/TTHAnalysis/data/btag/bTagEffs.root", wp="M", algo='deepcsv', btag_branch="btagDeepB", year=2016)
eventBTagWeight_17Fast = lambda : BTagEventWeightFriendFast(csvfile=os.environ["CMSSW_BASE"]+"/src/CMGTools/TTHAnalysis/data/btag/DeepCSV_94XSF_V4_B_F.csv", csvfastsim=os.environ["CMSSW_BASE"]+"/src/CMGTools/TTHAnalysis/data/btag/deepcsv_13TEV_17SL_18_3_2019.csv", eff_rootfile=os.environ['CMSSW_BASE']+"/src/CMGTools/TTHAnalysis/data/btag/bTagEffs.root", wp="M", algo='deepcsv', btag_branch="btagDeepB", year=2017)
eventBTagWeight_18Fast = lambda : BTagEventWeightFriendFast(csvfile=os.environ["CMSSW_BASE"]+"/src/CMGTools/TTHAnalysis/data/btag/DeepCSV_102XSF_V1.csv", csvfastsim=os.environ["CMSSW_BASE"]+"/src/CMGTools/TTHAnalysis/data/btag/deepcsv_13TEV_18SL_7_5_2019.csv", eff_rootfile=os.environ['CMSSW_BASE']+"/src/CMGTools/TTHAnalysis/data/btag/bTagEffs.root", wp="M", algo='deepcsv', btag_branch="btagDeepB", year=2018)
