...
metAna = cfg.Analyzer(
    ...
    includeTkMetNoPV = True,
    includeTkMetPVUsedInFit = True,
    includeTkMetUsedInFitTight = True,
    includeTkMetUsedInFitLoose = True,
    includeTkMetCompatibilityDz = True,
    includeTkMetCompatibilityBTag = True,
    includeTkMetNotReconstructedPrimary = True,
    includeTkMetOtherDeltaZ = True,
    doMetNoPU = False,
    doMetNoMu = False,
    doMetNoEle = False,
