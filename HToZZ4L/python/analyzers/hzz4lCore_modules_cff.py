...
jetAna = cfg.Analyzer(
    ...
    minLepPt = 0,
    lepSelCut = lambda lepton : lepton.tightId() and lepton.relIsoAfterFSR < 0.35,
    relaxJetId = False,  
    doPuId = False,
    ...
    doQG = True,
    #QGpath = "{CMSSW_BASE}/src/CMGTools/Heppy/data/pdfQG_AK4chs_13TeV_v2_PU20bx25_QCD_AllPtBins.root",
