...
function do_friends_heppy {
    ...
    case $1 in
        ttHMC)
            echo "python prepareEventVariablesFriendTree.py --tra2 $SRC {P}/1_recleaner_v0 --tree treeProducerSusyMultilepton -I CMGTools.NanoProc.tools.functionsTTH -m jetPtRatiov3 -m leptonJetFastReCleanerTTH_step1 -m leptonJetFastReCleanerTTH_step2_mc -d $2 -j 0"
            python prepareEventVariablesFriendTree.py --tra2 $SRC {P}/1_recleaner_v0 --tree treeProducerSusyMultilepton -I CMGTools.NanoProc.tools.functionsTTH -m jetPtRatiov3 -m leptonJetFastReCleanerTTH_step1 -m leptonJetFastReCleanerTTH_step2_mc -d $2 -j 0
            python prepareEventVariablesFriendTree.py --tra2 $SRC {P}/2_eventVars_v0 --tree treeProducerSusyMultilepton -I CMGTools.NanoProc.tools.functionsTTH -m eventVars -F sf/t {P}/1_recleaner_v0/evVarFriend_{cname}.root -d $2 -j 0
            ;;
        ttHData)
            python prepareEventVariablesFriendTree.py --tra2 $SRC {P}/1_recleaner_v0 --tree treeProducerSusyMultilepton -I CMGTools.NanoProc.tools.functionsTTH -m jetPtRatiov3 -m leptonJetFastReCleanerTTH_step1 -m leptonJetFastReCleanerTTH_step2_data -d $2 -j 0
            python prepareEventVariablesFriendTree.py --tra2 $SRC {P}/2_eventVars_v0 --tree treeProducerSusyMultilepton -I CMGTools.NanoProc.tools.functionsTTH -m eventVars -F sf/t {P}/1_recleaner_v0/evVarFriend_{cname}.root -d $2 -j 0
            ;;
    esac;
    popd
    ...
    nano_ttHMC-recl)
        if test -d ${DIR/-recl/}; then
            if $RUN; then
                ...
                MODS=CMGTools.NanoProc.tools.nanoAOD.ttH_modules
