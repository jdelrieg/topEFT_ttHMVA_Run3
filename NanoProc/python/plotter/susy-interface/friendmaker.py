...
for module in mm.getFriendModules():
        ...
        mm.workdir = mm.cmssw +"/src/CMGTools/NanoProc/macros"
        ...
        if options.bk and file:
                func.cp(mm.cmssw+"/src/CMGTools/NanoProc/macros/prepareEventVariablesFriendTree.py", output+"/ref")
                func.cp(mm.cmssw+"/src/CMGTools/NanoProc/python/tools/"+file                       , output+"/ref")
...
if options.direct and options.finalize and not options.noSplit:
        ...
        for module in mm.getFriendModules():
                mm.workdir = output
                func.cmd("chmod 755 "+mm.cmssw+"/src/CMGTools/NanoProc/macros/leptons/friendChunkAdd.sh")
                cmd = mm.cmssw +"/src/CMGTools/NanoProc/macros/leptons/friendChunkAdd.sh evVarFriend ."
        ...
        mm.addToTalk("cd "+mm.cmssw+"/src/CMGTools/NanoProc/macros")
