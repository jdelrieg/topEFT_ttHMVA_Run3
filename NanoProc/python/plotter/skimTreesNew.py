#!/usr/bin/env python
#from mcPlots import *
from CMGTools.NanoProc.plotter.mcAnalysis import MCAnalysis, CutsFile, addMCAnalysisOptions, scalarToVector
...
if __name__ == "__main__":
    ...
    if options.skimFriends and not options.justcount:
        skimFTrees = os.path.expandvars("$CMSSW_BASE/src/CMGTools/NanoProc/python/plotter/skimFTreesNew.py")
