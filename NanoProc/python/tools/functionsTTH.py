...
from CMGTools.NanoProc.tools.leptonJetReCleaner import LeptonJetReCleaner
from CMGTools.NanoProc.tools.conept import conept_TTH

MODULES=[]

from CMGTools.NanoProc.tools.combinedObjectTaggerForCleaning import *
from CMGTools.NanoProc.tools.fastCombinedObjectRecleaner import *
from CMGTools.NanoProc.tools.objFloatCalc import ObjFloatCalc
...
from CMGTools.NanoProc.tools.eventVars_2lss import EventVars2LSS
MODULES.append( ('eventVars', lambda : EventVars2LSS('','Recl')) )

from CMGTools.NanoProc.tools.kinMVA_2D_2lss_3l import KinMVA_2D_2lss_3l
MODULES.append( ('kinMVA_2D_2lss_3l', lambda : KinMVA_2D_2lss_3l(os.environ["CMSSW_BASE"]+"/src/CMGTools/NanoProc/data/kinMVA/tth/%s_BDTG.weights.xml", useTT_2lss='v8,rTT,httTT', useMEM_3l = False)) )
MODULES.append( ('noTTMVA_2D_2lss_3l', lambda : KinMVA_2D_2lss_3l(os.environ["CMSSW_BASE"]+"/src/CMGTools/NanoProc/data/kinMVA/tth/%s_BDTG.weights.xml", useTT_2lss='', useMEM_3l = False)) )
MODULES.append( ('kinMEMMVA_2D_2lss_3l', lambda : KinMVA_2D_2lss_3l(os.environ["CMSSW_BASE"]+"/src/CMGTools/NanoProc/data/kinMVA/tth/%s_BDTG.weights.xml", useTT_2lss='v8,rTT,httTT', useMEM_3l = True)) )

from CMGTools.NanoProc.tools.BDTv8_eventReco_cpp import BDTv8_eventReco
MODULES.append( ('oldcode_BDTv8_Hj', lambda : BDTv8_eventReco(os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_bloose_BDTG.weights.xml',
                                                      os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_btight_BDTG.weights.xml',
                                                      os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hj_csv_BDTG.weights.xml',
                                                      os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hjj_csv_BDTG.weights.xml',
                                                      selection = [
...
from CMGTools.NanoProc.tools.BDT_eventReco_cpp import BDT_eventReco
MODULES.append( ('BDTv8_Hj', lambda : BDT_eventReco(os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_bloose_BDTG.weights.xml',
                                                    os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_btight_BDTG.weights.xml',
                                                    os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hj_2017_configA_dcsv_BDTG.weights.xml',
                                                    os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hjj_csv_BDTG.weights.xml',
                                                    os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/resTop_xgb_csv_order_deepCTag.xml.gz',
                                                    os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/HadTopTagger_resolved_XGB_CSV_sort_withKinFit.xml.gz',
                                                    os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TF_jets_kinfit_httTT.root',
...
MODULES.append( ('BDTrTT_Hj', lambda : BDT_eventReco(os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_bloose_BDTG.weights.xml',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_btight_BDTG.weights.xml',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hj_2017_configA_dcsv_BDTG.weights.xml',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hjj_csv_BDTG.weights.xml',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/resTop_xgb_csv_order_deepCTag.xml.gz',
...
MODULES.append( ('BDThttTT_Hj', lambda : BDT_eventReco(os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_bloose_BDTG.weights.xml',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_btight_BDTG.weights.xml',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hj_2017_configA_dcsv_BDTG.weights.xml',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hjj_csv_BDTG.weights.xml',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/resTop_xgb_csv_order_deepCTag.xml.gz',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/HTT_HadTopTagger_2017_nomasscut_nvar17_resolved.xml',
                                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TF_jets_kinfit_httTT.root',
...
from CMGTools.NanoProc.tools.evtTagger import EvtTagger
...
from CMGTools.NanoProc.tools.objTagger import ObjTagger
...
from CMGTools.NanoProc.tools.bTagEventWeightsCSVFullShape import BTagEventWeightFriend
MODULES.append( ('eventBTagWeight', lambda : BTagEventWeightFriend(csvfile=os.environ["CMSSW_BASE"]+"/src/CMGTools/NanoProc/data/btag/DeepCSV_94XSF_V2_B_F.csv",
                                                                   discrname="btagDeepCSV")))

from CMGTools.NanoProc.tools.higgsRecoTTH import HiggsRecoTTH
...
from CMGTools.NanoProc.tools.ttHMCEventReco import TTHMCEventReco
MODULES.append( ('genLevelChain', lambda : TTHMCEventReco()) )

from CMGTools.NanoProc.tools.matchRecoToPartonsTTH import MatchRecoToPartonsTTH
MODULES.append( ('matchPartons', lambda : MatchRecoToPartonsTTH(label="_Recl")) )

from CMGTools.NanoProc.tools.vertexWeightFriend import VertexWeightFriend
...
MODULES.append( ('vtxWeight', lambda : VertexWeightFriend(myfile=None, targetfile=os.environ["CMSSW_BASE"]+"/src/CMGTools/NanoProc/data/pileup/puWeights_2017_41p4fb_rereco_69p2mb.root",
                                                          myhist=None,targethist="pileup",name="vtxWeight2017",
                                                          verbose=False,vtx_coll_to_reweight="nTrueInt",autoPU=True)) )

from CMGTools.NanoProc.tools.bestHmmFriend import BestHmm
