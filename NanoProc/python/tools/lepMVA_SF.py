...
class AllLepSFs:
    def __init__(self):
        self.f_el = ROOT.TFile("%s/src/CMGTools/NanoProc/data/MVAandTigthChargeSF_ele.root" % os.environ['CMSSW_BASE'])
        self.f_mu = ROOT.TFile("%s/src/CMGTools/NanoProc/data/MVAandTigthChargeSF_mu.root"  % os.environ['CMSSW_BASE'])
