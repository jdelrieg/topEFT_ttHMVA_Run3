...
from CMGTools.NanoProc.tools.leptonJetReCleaner import passMllTLVeto, passTripleMllVeto
...
for extlib in ["triggerSF/triggerSF_fullsim_UCSx_v5_01.cc","leptonSF/lepton_SF_UCSx_v5_03.cc","triggerSF/FastSimTriggerEff.cc"]:
    ...
    if "/%s"%extlib.replace(".cc","_cc.so") not in ROOT.gSystem.GetLibraries():
        ROOT.gROOT.LoadMacro(os.environ["CMSSW_BASE"]+"/src/CMGTools/NanoProc/data/%s+"%extlib)
...
from CMGTools.NanoProc.tools.leptonChoiceRA5 import _susy2lss_lepId_IPcuts
