...
class finalMVA_DNN_3l(Module):
    def __init__(self, variations=[], doSystJEC=True):
        ...
        for var in self.systsJEC: 
            self._MVAs.append( TFTool('DNN_3l%s'%self.systsJEC[var], os.environ['CMSSW_BASE'] + '/src/CMGTools/NanoProc/data/kinMVA/tth/3l_0tau_DNN_legacy.pb',
        ...
        worker_3l_unclUp   = TFTool("DNN_3l_unclUp", os.environ['CMSSW_BASE'] + '/src/CMGTools/NanoProc/data/kinMVA/tth/3l_0tau_DNN_legacy.pb', vars_3l_unclEnUp, cats_3l, varorder)
        worker_3l_unclDown = TFTool("DNN_3l_unclDown", os.environ['CMSSW_BASE'] + '/src/CMGTools/NanoProc/data/kinMVA/tth/3l_0tau_DNN_legacy.pb', vars_3l_unclEnDown,cats_3l,  varorder)
