...
from CMGTools.NanoProc.treeReAnalyzer import Collection as CMGCollection
from CMGTools.NanoProc.tools.nanoAOD.friendVariableProducerTools import declareOutput, writeOutput
from CMGTools.NanoProc.tools.tfTool import TFTool
import os 
...
class finalMVA_DNN(Module):
    def __init__(self, variations=[], doSystJEC=True, fillInputs=False):
        ...
        for var in self.systsJEC: 
            self._MVAs.append( TFTool('DNN_2lss%s'%self.systsJEC[var], os.environ['CMSSW_BASE'] + '/src/CMGTools/NanoProc/data/kinMVA/tth/2017tautag2p1samples_xsecrwonly_oldvars_tH_selection.pb',
        ...
        worker_2lss_unclUp        = TFTool('DNN_2lss_unclUp', os.environ['CMSSW_BASE'] + '/src/CMGTools/NanoProc/data/kinMVA/tth/2017tautag2p1samples_xsecrwonly_oldvars_tH_selection.pb',
                                           vars_2lss_unclUp, cats_2lss, varorder)
        worker_2lss_unclDown      = TFTool('DNN_2lss_unclDown', os.environ['CMSSW_BASE'] + '/src/CMGTools/NanoProc/data/kinMVA/tth/2017tautag2p1samples_xsecrwonly_oldvars_tH_selection.pb',
