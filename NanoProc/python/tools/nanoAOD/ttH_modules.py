...
from CMGTools.NanoProc.tools.nanoAOD.jetmetGrouper import groups as jecGroups
...
from CMGTools.NanoProc.tools.nanoAOD.jetmetGrouper import jetMetCorrelate2016, jetMetCorrelate2017, jetMetCorrelate2018
from CMGTools.NanoProc.tools.nanoAOD.jetMetCorrelator import jetMetCorrelations2016, jetMetCorrelations2017, jetMetCorrelations2018
...
BDThttTT_Hj = lambda : BDT_eventReco(os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_bloose_BDTG.weights.xml',
                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_btight_BDTG.weights.xml',
                                     os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hjtagger_legacy_xgboost_v1.weights.xml',
...
BDThttTT_allvariations = lambda : BDT_eventReco(os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_bloose_BDTG.weights.xml',
                                                os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/TMVAClassification_btight_BDTG.weights.xml',
                                                os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hjtagger_legacy_xgboost_v1.weights.xml',
                                                os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/Hjj_csv_BDTG.weights.xml',
                                                os.environ["CMSSW_BASE"]+'/src/CMGTools/NanoProc/data/kinMVA/tth/resTop_xgb_csv_order_deepCTag.xml.gz',
...
from CMGTools.NanoProc.tools.nanoAOD.BtagSFs import BtagSFs
...
from CMGTools.NanoProc.tools.nanoAOD.lepScaleFactors import lepScaleFactors
...
from CMGTools.NanoProc.tools.nanoAOD.higgsDecayFinder import higgsDecayFinder
higgsDecay = lambda : higgsDecayFinder()

from CMGTools.NanoProc.tools.nanoAOD.VHsplitter import VHsplitter
vhsplitter = lambda : VHsplitter()

# from CMGTools.NanoProc.tools.synchTools import SynchTuples
...
# 5_evtVars_v0
from CMGTools.NanoProc.tools.nanoAOD.ttH_gen_reco import ttH_gen_reco
