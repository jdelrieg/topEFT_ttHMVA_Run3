...
from CMGTools.NanoProc.tools.nanoAOD.friendVariableProducerTools import writeOutput
...
class FinalMVA_4L(Module):
    def __init__(self):
        ...
        P = os.environ["CMSSW_BASE"] + '/src/CMGTools/NanoProc/data/kinMVA/tth/4l_0tau_3.xml' 
