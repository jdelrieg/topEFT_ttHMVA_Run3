...
class puWeightProducer(Module):
    def __init__(self,
        ...
        try:
            ROOT.gSystem.Load("libCMGToolsNanoProc.so")
    ...
    def loadHisto(self, filename, hname):
        print(f"Getting {hname} from {filename}")
...
pufile_mc2016 = "%s/src/CMGTools/NanoProc/data/pileup/pileup_profile_Summer16.root" % os.environ[
    'CMSSW_BASE']
pufile_data2016 = "%s/src/CMGTools/NanoProc/data/pileup/PileupData_GoldenJSON_Full2016.root" % os.environ[
    'CMSSW_BASE']
...
pufile_data2017 = "%s/src/CMGTools/NanoProc/data/pileup/PileupHistogram-goldenJSON-13tev-2017-99bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mc2017 = "%s/src/CMGTools/NanoProc/data/pileup/mcPileup2017.root" % os.environ[
    'CMSSW_BASE']
...
pufile_data2018 = "%s/src/CMGTools/NanoProc/data/pileup/PileupHistogram-goldenJSON-13tev-2018-100bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mc2018 = "%s/src/CMGTools/NanoProc/data/pileup/mcPileup2018.root" % os.environ[
    'CMSSW_BASE']
...
# 2016
pufile_dataUL2016 = "%s/src/CMGTools/NanoProc/data/pileup/PileupHistogram-UL2016-100bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mcUL2016 = "%s/src/CMGTools/NanoProc/data/pileup/mcPileupUL2016.root" % os.environ[
    'CMSSW_BASE']
...
# 2017
pufile_dataUL2017 = "%s/src/CMGTools/NanoProc/data/pileup/PileupHistogram-UL2017-100bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mcUL2017 = "%s/src/CMGTools/NanoProc/data/pileup/mcPileupUL2017.root" % os.environ[
    'CMSSW_BASE']
...
# 2018
pufile_dataUL2018 = "%s/src/CMGTools/NanoProc/data/pileup/PileupHistogram-UL2018-100bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mcUL2018 = "%s/src/CMGTools/NanoProc/data/pileup/mcPileupUL2018.root" % os.environ[
    'CMSSW_BASE']
...
puAutoWeight_2022 = lambda: puWeightProducer('auto',
                                             "/eos/user/c/cmsdqm/www/CAF/certification/Collisions22/PileUp/BCD/pileupHistogram-Cert_Collisions2022_355100_357900_eraBCD_GoldenJson-13p6TeV-69200ub-99bins.root", 
                                             "pu_mc",
                                             "pileup",
                                             verbose=False,
                                             doSysVar=False) # not yet available?
puAutoWeight_2022EE = lambda: puWeightProducer('auto',
                                              "/eos/user/c/cmsdqm/www/CAF/certification/Collisions22/PileUp/EFG/pileupHistogram-Cert_Collisions2022_359022_362760_eraEFG_GoldenJson-13p6TeV-69200ub-99bins.root", 
                                              "pu_mc",
                                              "pileup",
                                              verbose=False,
                                              doSysVar=False) # not yet available
