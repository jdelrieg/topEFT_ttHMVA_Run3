...
class yearTagger( Module ):
    ...
    def initComponent(self, component):
        if hasattr(component, 'year'):
            ...
            self._year = 2016
        elif ("Summer22" in component.dataset) or ("Run2022" in component.dataset):
            self._year = 2022
        else:
        ...
        if hasattr(component, 'suberaId'):
            ...
            if ("2022EE" in component.dataset) or ("Run2022E" in component.dataset) or ( "Run2022F" in component.dataset):
                self._suberaId=1
            else:
                self._suberaId=0
