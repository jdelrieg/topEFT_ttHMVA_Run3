...
from CMGTools.NanoProc.tools.nanoAOD.susySOS_modules import conf, muonSelection, electronSelection, calculateRawMVA, SOSTightID2018, susyEleIdParametrization, VLooseFOEleID, tightEleID, clean_and_FO_selection_SOS, fullCleaningLeptonSel, fullTightLeptonSel, tightLepDY, tightLepTT, tightLepVV, tightLepWZ
