...
lepMVA_probando=lambda : lepMVAWZ_run3("CMSSW_14_0_6/src/CMGTools/NanoProc/data/leptonMVA/tth/", "Electron-mvaTTH.2022EE.weights_mvaISO.xml","Muon-mvaTTH.2022EE.weights.xml")#,inputVars = {"muons":  mvatth_cfg.muon_df("2022"), "electrons" : mvatth_cfg.electron_df_wIso("2022")})
...
if __name__ == '__main__':
    ...
    process = "tree_12"
    mainpath ="/mnt_pool/c3_users/user/jriego/TopEFT/LobsterSkimming"
    process = "sampleEFT"
    ...
    print('VARS, electrons',mvatth_cfg.electron_df_wIso("2022"),'\n muons',mvatth_cfg.muon_df("2022"))
