#!/usr/bin/env python
from CMGTools.NanoProc.treeReAnalyzer import *
import re,os
...
bTagSFEvent3WP = BTagSFEvent(
    #BTag_SFb("%s/src/CMGTools/NanoProc/data/btag/SFb-pt_payload_Moriond13.txt" % os.environ['CMSSW_BASE']),
    #BTag_SFLight("%s/src/CMGTools/NanoProc/data/btag/SFLightFuncs_Moriond2013_ABCD.txt" % os.environ['CMSSW_BASE']),
    BTag_SFb("%s/src/CMGTools/NanoProc/data/btag/SFb-pt_WITHttbar_payload_EPS13.txt" % os.environ['CMSSW_BASE']),
    BTag_SFLight("%s/src/CMGTools/NanoProc/data/btag/SFlightFuncs_EPS2013.C.txt" % os.environ['CMSSW_BASE']),
    "%s/src/CMGTools/NanoProc/data/btag/bTagEff_TTMC.root" % os.environ['CMSSW_BASE'],
