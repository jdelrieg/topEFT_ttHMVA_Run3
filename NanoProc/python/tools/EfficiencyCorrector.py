import ROOT
from CMGTools.NanoProc.tools.WeightCalculatorFromHistogram import WeightCalculatorFromHistogram as WeightCalculator
from CMGTools.NanoProc.tools.fullPath import getFullPath
