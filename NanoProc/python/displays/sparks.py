...
from CMGTools.NanoProc.plotter.tree2yield import CutsFile, scalarToVector
...
class CanvasMaker(Module):
    def __init__(self,name,maxEvents=100,maxEta=5):
        Module.__init__(self,name,booker=None)
        ROOT.gROOT.ProcessLine(".x %s/src/CMGTools/NanoProc/python/plotter/tdrstyle.cc" % os.environ['CMSSW_BASE']);
