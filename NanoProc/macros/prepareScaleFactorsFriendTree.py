...
from CMGTools.NanoProc.tools.btagSFs_POG import bTagSFEvent3WPErrs as btagSFEvent
#MODULES += [ ('btag', btagSFEvent) ]

from CMGTools.NanoProc.tools.lepMVA_SF import AllLepSFs
MODULES += [ ('lep',AllLepSFs())  ]

from CMGTools.NanoProc.tools.lepTrigger_SF import LepTriggerSF_Event
#MODULES += [ ('trig2l', LepTriggerSF_Event())  ]

from CMGTools.NanoProc.tools.metLD_reshape import MetLDReshaper
#MODULES += [ ('metLD', MetLDReshaper()) ]

from CMGTools.NanoProc.tools.btagRWTs_ND import BTag_RWT_EventErrs
