...
from CMGTools.NanoProc.plotter.rocCurves import hist2ROC1d
if "/rhoCorrections_cc.so" not in ROOT.gSystem.GetLibraries():
    ROOT.gROOT.ProcessLine(".L %s/src/CMGTools/NanoProc/macros/leptons/rhoCorrections.cc+" % os.environ['CMSSW_BASE']);
